...
import { calculateATSScore, getScoreColor, getScoreLabel, runAIATSAnalysis } from '../../lib/atsScoring';
import type { QualityIssue, KeywordGap, AIATSSuggestion } from '../../lib/atsScoring';
